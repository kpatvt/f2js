/* lmder_test.f -- translated by f2c (version 20160102).
...
/* Main program */ int MAIN__(void)
{
    ...
    static char fmt_80[] = "(\0021SUMMARY OF \002,i3,\002 CALLS TO LMDER1"
	    "\002/)";
    ...
    static integer lwa;
    static doublereal tol, fjac[2600]	/* was [65][40] */, fvec[65];
    static integer info;
    extern doublereal enorm_(integer *, doublereal *);
    extern /* Subroutine */ int lmder1_(U_fp, integer *, integer *, 
...
L10:
	...
	refnum_1.nfev = 0;
	refnum_1.njev = 0;
	lmder1_((U_fp)fcn_, &m, &n, x, fvec, fjac, &ldfjac, &tol, &info, iwa, 
		wa, &lwa);
	ssqfcn_(&m, &n, x, fvec, &refnum_1.nprob);
...
/* Subroutine */ int fcn_(integer *m, integer *n, doublereal *x, doublereal *
	fvec, doublereal *fjac, integer *ldfjac, integer *iflag)
{
    /* System generated locals */
...
/*     ********** */
    ...
    if (*iflag == 2) {
	ssqjac_(m, n, &x[1], &fjac[fjac_offset], ldfjac, &refnum_1.nprob);
    }
    if (*iflag == 1) {
	++refnum_1.nfev;
    }
