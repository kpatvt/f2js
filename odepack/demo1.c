/* demo1.f -- translated by f2c (version 20160102).
...
/* Main program */ int MAIN__(void)
{
    ...
    static doublereal tout1 = 1.39283880203;
    static doublereal dtout = 2.214773875;

    /* Format strings */
    static char fmt_110[] = "(/\002 Demonstration program for DLSODE packag"
	    "e\002///\002 Problem 1:  Van der Pol oscillator:\002/\002  xdotd"
	    "ot - 3*(1 - x**2)*xdot + x = 0, \002,\002   x(0) = 2, xdot(0) = 0"
	    "\002/\002 neq =\002,i2/\002 itol =\002,i3,\002   rtol =\002,d10."
	    "1,\002   atol =\002,d10.1//)";
    static char fmt_120[] = "(///\002 Solution with mf =\002,i3//5x,\002t   "
	    "            x               xdot       nq      h\002//)";
    static char fmt_140[] = "(d15.5,d16.5,d14.3,i5,d14.3)";
    static char fmt_150[] = "(//\002 Warning: error exceeds 1000 * toleranc"
	    "e\002//)";
    static char fmt_180[] = "(//\002 Final statistics for this run:\002/\002"
	    ...
	    ",d10.2)";
    static char fmt_210[] = "(///70(\002-\002)///\002 Problem 2: ydot = A * "
	    "y , where\002,\002  A is a banded lower triangular matrix\002/12"
	    "x,\002derived from 2-D advection PDE\002/\002 neq =\002,i3,\002 "
	    "  ml =\002,i2,\002   mu =\002,i2/\002 itol =\002,i3,\002   rtol ="
	    "\002,d10.1,\002   atol =\002,d10.1//)";
    static char fmt_220[] = "(///\002 Solution with mf =\002,i3//5x,\002t   "
	    "          max.err.     nq      h\002//)";
    static char fmt_240[] = "(d15.5,d14.3,i5,d14.3)";
    ...
    extern /* Subroutine */ int edit2_(doublereal *, doublereal *, doublereal 
	    *);
    static integer mband, iopar, itask, leniw, miter, lenrw, iwork[45];
    static doublereal rwork[697];
    extern /* Subroutine */ int dlsode_(U_fp, integer *, doublereal *, 
    ...
    static cilist io___39 = { 0, 0, 0, fmt_180, 0 };
    static cilist io___43 = { 0, 0, 0, fmt_210, 0 };
    static cilist io___44 = { 0, 0, 0, fmt_220, 0 };
    static cilist io___47 = { 0, 0, 0, fmt_240, 0 };
    static cilist io___48 = { 0, 0, 0, fmt_150, 0 };
    static cilist io___49 = { 0, 0, 0, fmt_180, 0 };
    static cilist io___50 = { 0, 0, 0, fmt_300, 0 };
...
/* First problem */
	...
	for (miter = 0; miter <= 3; ++miter) {
		...
		dlsode_((U_fp)f1_, &neq, y, &t, &tout, &itol, &rtol, &atol, &
...
/* L230: */
	    ...
	    i__1 = nout;
	    for (iout = 1; iout <= i__1; ++iout) {
		dlsode_((U_fp)f2_, &neq, y, &t, &tout, &itol, &rtol, &atol, &
			itask, &istate, &iopt, rwork, &lrw, iwork, &liw, (
			U_fp)jac2_, &mf);
		edit2_(y, &t, &erm);
		hu = rwork[10];
	...
	integer *ml, integer *mu, doublereal *pd, integer *nrowpd)
{
    ...
    pd[pd_dim1 + 1] = 0.;
    pd[(pd_dim1 << 1) + 1] = 1.;
    pd[pd_dim1 + 2] = y[1] * -6. * y[2] - 1.;
    pd[(pd_dim1 << 1) + 2] = (1. - y[1] * y[1]) * 3.;
    return 0;
} /* jac1_ */
